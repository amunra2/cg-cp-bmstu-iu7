...
def build_graph():
    ...
    particles = [500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000]
    fps = [210, 120, 80, 50, 34, 27, 21, 18, 16, 14, 12, 11, 10, 9, 8, 7]
    ...
    plt.legend()
    plt.grid()
    plt.title("Зависимость производительности от количества частиц")
    plt.ylabel("Проиводительность, к/c")
    plt.xlabel("Частиц, штук")
